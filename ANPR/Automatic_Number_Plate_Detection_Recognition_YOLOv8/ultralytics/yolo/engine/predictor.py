    ...
    def __call__(self, source=None, model=None):
        ...
        for batch in self.dataset:
            ...
            for i in range(len(im)):
                ...
                license=self.write_results(i, preds, (p, im, im0s))
                # if license==0:
                #     continue
                # print("123",license)
                number_plate.append(license)
                # print("123 number",number_plate)
                if self.args.show:
                    self.show(p)

                # if self.args.save:
                    # print("Hello123",license)
